        ...
        <div class="modal-dialog login animated">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" v-if="!displayName">Login with</h4>
              <h4 class="modal-title" v-if="displayName">Logout</h4>
              ...
              <div class="box">
                <div class="content">
                  <div class="social" v-if="!displayName">
                    ...
                    <a id="facebook_login" class="circle facebook" @click="login('facebook')" href="#">
